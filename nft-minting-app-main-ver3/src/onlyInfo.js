      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          <s.Container flex={1} jc={"center"} ai={"center"}>
            <StyledImg alt={"example"} src={"/config/images/npoop.jpeg"}/>
          ...
          >
            ...
            >
              ...
              <StyledLogoSmall src={"/config/images/twitter.webp"} />
              <s.SpacerA/>
            </s.TextDescription>
            <span
              style={{
        ...
        <s.Container
          ...
          <s.TextTitle
            ...
            <s.TextDescription
                  style={{ textAlign: "center", color: "var(--accent-text)" }}
                >
              Feb 8, 2022 - Register open for whitelist spot
            </s.TextDescription>

            <s.TextDescription
                  style={{ textAlign: "center", color: "var(--accent-text)" }}
                >
              Feb 13, 2022 - Pre-sale open for Whitelist at discount
            </s.TextDescription>
            <s.TextDescription
                  style={{ textAlign: "center", color: "var(--accent-text)" }}
                >
              Feb 14, 2022 - Bored Valentine Guy Club launch
            </s.TextDescription>
            <s.TextDescription
                  style={{ textAlign: "center", color: "var(--accent-text)" }}
                >
